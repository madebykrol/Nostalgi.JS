...
NOSTALGI.IO.KeyboardListener = function(key, callback) {
	this.key = key;
	this.callback = callback;
}
NOSTALGI.IO.KeyboardListener.prototype = Object.create(NOSTALGI.Object.prototype);


NOSTALGI.IO.EventTrigger = function () {
	...
	this.AddKeyPressEventListener = function (listener) {
		keyPressEvents[listener.key] = listener.callback;
	}
}